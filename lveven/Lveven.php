...
class Lveven
{
    ...
    {
        return [
            'lveven\base\Controller' => CORE_PATH . '/base/Controller.php',
            'lveven\base\Model' => CORE_PATH . '/base/Model.php',
            'lveven\base\View' => CORE_PATH . '/base/View.php',
            'lveven\db\Db' => CORE_PATH . '/db/Db.php',
            'lveven\db\Sql' => CORE_PATH . '/db/Sql.php',
        ];
    }
}